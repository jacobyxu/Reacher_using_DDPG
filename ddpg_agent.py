...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, n_agent = 1):
        ...
        # Add noise process for each agent
        self.noise = [OUNoise(action_size, random_seed*i) for i in range(self.n_agent)]
        
        # Initialize time step (for updating every UPDATE_EVERY steps)
        self.t_step = [0]*self.n_agent
    ...
    def step(self, state, action, reward, next_state, done, agent_x):
        ...
        Params
        ======
            state, action, reward, next_state, done: s, a, r, s', done from environment
